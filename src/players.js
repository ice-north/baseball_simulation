  ...
  return [
    {
      ...
      catching: { lead: 40 },
      pitching: {
        velocity: 127, control: 45, stamina: 80,
        form: 'threeQuarter',
        arsenal: [
    ...
    },
    {
      ...
      catching: { lead: 50 },
      pitching: {
        velocity: 137, control: 45, stamina: 100,
        form: 'threeQuarter',
        arsenal: [
          { id: 1, type: 'straight', level: 100 },
    ...
    },
    {
      ...
      catching: { lead: 40 },
      pitching: {
        velocity: 127, control: 40, stamina: 90,
        form: 'threeQuarter',
        arsenal: [
          { id: 1, type: 'straight', level: 100 },
    ...
    },
    {
      ...
      catching: { lead: 45 },
      pitching: {
        velocity: 134, control: 48, stamina: 95,
        form: 'threeQuarter',
        arsenal: [
          { id: 1, type: 'straight', level: 100 },
          { id: 2, type: 'slider', level: 35 }
    ...
    },
    {
      ...
      catching: { lead: 50 },
      pitching: {
        velocity: 130, control: 50, stamina: 85,
        form: 'threeQuarter',
        arsenal: [
          { id: 1, type: 'straight', level: 100 },
    ...
    },
    {
      ...
      catching: { lead: 48 },
      pitching: {
        velocity: 140, control: 52, stamina: 100,
        form: 'threeQuarter',
        arsenal: [
          { id: 1, type: 'straight', level: 100 },
    ...
    },
    {
      ...
      catching: { lead: 70 },
      pitching: {
        velocity: 137, control: 45, stamina: 70,
        form: 'threeQuarter',
        arsenal: [
          { id: 1, type: 'straight', level: 100 },
    ...
    },
    {
      ...
      physical: { speed: 40, arm: 88, throws: 'right', bodyStamina: 58, recovery: 46 },
      fielding: { defense: 55 },
      catching: { lead: 55 },
      pitching: {
  ...
  return [
    {
      ...
      catching: { lead: 35 },
      pitching: {
        velocity: 124, control: 40, stamina: 75,
        form: 'threeQuarter',
        arsenal: [
          { id: 1, type: 'straight', level: 100 },
    ...
    },
    {
      ...
      catching: { lead: 50 },
      pitching: {
        velocity: 127, control: 55, stamina: 85,
        form: 'threeQuarter',
        arsenal: [
          { id: 1, type: 'straight', level: 100 },
    ...
    },
    {
      ...
      catching: { lead: 35 },
      pitching: {
        velocity: 124, control: 35, stamina: 80,
        form: 'threeQuarter',
        arsenal: [
          { id: 1, type: 'straight', level: 100 },
          { id: 2, type: 'sinker', level: 30 }
    ...
    },
    {
      ...
      catching: { lead: 50 },
      pitching: {
        velocity: 137, control: 45, stamina: 90,
        form: 'threeQuarter',
        arsenal: [
          { id: 1, type: 'straight', level: 100 },
    ...
    },
    {
      ...
      catching: { lead: 55 },
      pitching: {
        velocity: 127, control: 52, stamina: 88,
        form: 'threeQuarter',
        arsenal: [
          { id: 1, type: 'straight', level: 100 },
          { id: 2, type: 'slider', level: 30 }
    ...
    },
    {
      ...
      catching: { lead: 40 },
      pitching: {
        velocity: 146, control: 48, stamina: 95,
        form: 'threeQuarter',
        arsenal: [
          { id: 1, type: 'straight', level: 100 },
    ...
    },
    {
      ...
      catching: { lead: 80 },
      pitching: {
        velocity: 140, control: 50, stamina: 65,
        form: 'threeQuarter',
        arsenal: [
          { id: 1, type: 'straight', level: 100 },
          { id: 2, type: 'curve', level: 25 }
    ...
    },
    {
      ...
      physical: { speed: 45, arm: 95, throws: 'right', bodyStamina: 63, recovery: 53 },
      fielding: { defense: 60 },
      catching: { lead: 50 },
      pitching: {
...
export const createHomeBench = () => {
  return [
    ...
    { id: 10, name: '代打の切り札', position: 'first', isStarter: false, battingOrder: 0,
      ...
      pitching: { velocity: 124, control: 40, stamina: 70, form: 'threeQuarter',
    ...
    { id: 11, name: '守備固め', position: 'second', isStarter: false, battingOrder: 0,
      ...
      pitching: { velocity: 130, control: 45, stamina: 75, form: 'threeQuarter',
    ...
    { id: 12, name: '代走要員', position: 'center', isStarter: false, battingOrder: 0,
      ...
      pitching: { velocity: 120, control: 38, stamina: 65, form: 'threeQuarter',
    ...
    { id: 13, name: 'ユーティリティ', position: 'short', isStarter: false, battingOrder: 0,
      ...
      pitching: { velocity: 134, control: 48, stamina: 80, form: 'threeQuarter',
    ...
    { id: 14, name: '若手有望株', position: 'third', isStarter: false, battingOrder: 0,
      ...
      pitching: { velocity: 132, control: 42, stamina: 85, form: 'threeQuarter',
    ...
    { id: 15, name: 'ベテラン控え', position: 'left', isStarter: false, battingOrder: 0,
      ...
      pitching: { velocity: 124, control: 50, stamina: 70, form: 'threeQuarter',
    ...
    { id: 16, name: '外野手控え', position: 'right', isStarter: false, battingOrder: 0,
      ...
      pitching: { velocity: 137, control: 45, stamina: 90, form: 'threeQuarter',
    ...
    { id: 17, name: '控え捕手', position: 'catcher', isStarter: false, battingOrder: 0,
      ...
      pitching: { velocity: 134, control: 48, stamina: 60, form: 'threeQuarter',
    ...
    { id: 18, name: 'セットアッパー', position: 'pitcher', isStarter: false, battingOrder: 0,
      ...
      physical: { speed: 40, arm: 92, throws: 'right', bodyStamina: 47, recovery: 57 }, fielding: { defense: 50 }, catching: { lead: 45 },
    ...
    { id: 19, name: 'クローザー', position: 'pitcher', isStarter: false, battingOrder: 0,
      ...
      physical: { speed: 38, arm: 98, throws: 'right', bodyStamina: 48, recovery: 56 }, fielding: { defense: 48 }, catching: { lead: 42 },
    ...
    { id: 20, name: '中継ぎ左腕', position: 'pitcher', isStarter: false, battingOrder: 0,
      ...
      physical: { speed: 42, arm: 80, throws: 'left', bodyStamina: 72, recovery: 56 }, fielding: { defense: 52 }, catching: { lead: 48 },
    ...
    { id: 21, name: 'ロングリリーフ', position: 'pitcher', isStarter: false, battingOrder: 0,
      ...
      physical: { speed: 42, arm: 77, throws: 'right', bodyStamina: 64, recovery: 53 }, fielding: { defense: 54 }, catching: { lead: 50 },
    ...
    { id: 22, name: 'サイド右腕', position: 'pitcher', isStarter: false, battingOrder: 0,
      ...
      physical: { speed: 40, arm: 72, throws: 'right', bodyStamina: 70, recovery: 46 }, fielding: { defense: 50 }, catching: { lead: 44 },
    ...
    { id: 23, name: 'アンダー投手', position: 'pitcher', isStarter: false, battingOrder: 0,
      ...
      physical: { speed: 38, arm: 62, throws: 'right', bodyStamina: 68, recovery: 59 }, fielding: { defense: 48 }, catching: { lead: 42 },
    ...
    { id: 24, name: '先発候補', position: 'pitcher', isStarter: false, battingOrder: 0,
      ...
      physical: { speed: 44, arm: 83, throws: 'right', bodyStamina: 62, recovery: 48 }, fielding: { defense: 56 }, catching: { lead: 52 },
...
export const createAwayBench = () => {
  return [
    ...
    { id: 10, name: '代打職人', position: 'first', isStarter: false, battingOrder: 0,
      ...
      pitching: { velocity: 126, control: 42, stamina: 72, form: 'threeQuarter',
        arsenal: [{ id: 1, type: 'straight', level: 100 }, { id: 2, type: 'sinker', level: 28 }] },
      positionFitness: { pitcher: 25, catcher: 30, first: 100, second: 55, third: 50, short: 50, left: 40, center: 30, right: 40 } },
    { id: 11, name: '内野控え', position: 'second', isStarter: false, battingOrder: 0,
      ...
      pitching: { velocity: 132, control: 48, stamina: 78, form: 'threeQuarter',
    ...
    { id: 12, name: '快足選手', position: 'center', isStarter: false, battingOrder: 0,
      ...
      pitching: { velocity: 122, control: 40, stamina: 68, form: 'threeQuarter',
    ...
    { id: 13, name: '万能選手', position: 'short', isStarter: false, battingOrder: 0,
      ...
      pitching: { velocity: 135, control: 50, stamina: 82, form: 'threeQuarter',
    ...
    { id: 14, name: 'ルーキー', position: 'third', isStarter: false, battingOrder: 0,
      ...
      pitching: { velocity: 130, control: 40, stamina: 82, form: 'threeQuarter',
    ...
    { id: 15, name: '外野控え1', position: 'left', isStarter: false, battingOrder: 0,
      ...
      pitching: { velocity: 126, control: 52, stamina: 72, form: 'threeQuarter',
    ...
    { id: 16, name: '外野控え2', position: 'right', isStarter: false, battingOrder: 0,
      ...
      pitching: { velocity: 139, control: 48, stamina: 92, form: 'threeQuarter',
    ...
    { id: 17, name: '第二捕手', position: 'catcher', isStarter: false, battingOrder: 0,
      ...
      pitching: { velocity: 135, control: 50, stamina: 62, form: 'threeQuarter',
    ...
    { id: 18, name: '勝利の方程式', position: 'pitcher', isStarter: false, battingOrder: 0,
      ...
      physical: { speed: 42, arm: 95, throws: 'right', bodyStamina: 66, recovery: 52 }, fielding: { defense: 52 }, catching: { lead: 48 },
    ...
    { id: 19, name: '守護神', position: 'pitcher', isStarter: false, battingOrder: 0,
      ...
      physical: { speed: 40, arm: 99, throws: 'right', bodyStamina: 69, recovery: 54 }, fielding: { defense: 50 }, catching: { lead: 44 },
      pitching: { velocity: 152, control: 75, stamina: 82, form: 'overhand',
    ...
    { id: 20, name: '左の中継ぎ', position: 'pitcher', isStarter: false, battingOrder: 0,
      ...
      physical: { speed: 44, arm: 83, throws: 'left', bodyStamina: 47, recovery: 72 }, fielding: { defense: 54 }, catching: { lead: 50 },
    ...
    { id: 21, name: 'イニングイーター', position: 'pitcher', isStarter: false, battingOrder: 0,
      ...
      physical: { speed: 44, arm: 80, throws: 'right', bodyStamina: 52, recovery: 72 }, fielding: { defense: 56 }, catching: { lead: 52 },
    ...
    { id: 22, name: 'サイド左腕', position: 'pitcher', isStarter: false, battingOrder: 0,
      ...
      physical: { speed: 42, arm: 68, throws: 'left', bodyStamina: 48, recovery: 57 }, fielding: { defense: 52 }, catching: { lead: 46 },
    ...
    { id: 23, name: 'サブマリン', position: 'pitcher', isStarter: false, battingOrder: 0,
      batting: { meet: 30, power: 26, eye: 40, bats: 'right', steal: 14 },
      physical: { speed: 40, arm: 65, throws: 'right', bodyStamina: 53, recovery: 59 }, fielding: { defense: 50 }, catching: { lead: 44 },
    ...
    { id: 24, name: '若手先発', position: 'pitcher', isStarter: false, battingOrder: 0,
      ...
      physical: { speed: 46, arm: 86, throws: 'right', bodyStamina: 65, recovery: 71 }, fielding: { defense: 58 }, catching: { lead: 54 },
