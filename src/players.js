...
export const createDefaultPlayers = () => {
  return [
    ...
    },
    {
      ...
      physical: { speed: 40, arm: 50, throws: 'right', bodyStamina: 58, recovery: 46 },
      fielding: { defense: 55 },
      catching: { lead: 55 },
      pitching: {
...
export const createAwayPlayers = () => {
  return [
    ...
    },
    {
      ...
      physical: { speed: 45, arm: 55, throws: 'right', bodyStamina: 63, recovery: 53 },
      fielding: { defense: 60 },
      catching: { lead: 50 },
      pitching: {
...
export const createHomeBench = () => {
  return [
    ...
    { id: 18, name: 'セットアッパー', position: 'pitcher', isStarter: false, battingOrder: 0,
      ...
      physical: { speed: 40, arm: 50, throws: 'right', bodyStamina: 47, recovery: 57 }, fielding: { defense: 50 }, catching: { lead: 45 },
    ...
    { id: 19, name: 'クローザー', position: 'pitcher', isStarter: false, battingOrder: 0,
      ...
      physical: { speed: 38, arm: 48, throws: 'right', bodyStamina: 48, recovery: 56 }, fielding: { defense: 48 }, catching: { lead: 42 },
    ...
    { id: 20, name: '中継ぎ左腕', position: 'pitcher', isStarter: false, battingOrder: 0,
      ...
      physical: { speed: 42, arm: 52, throws: 'left', bodyStamina: 72, recovery: 56 }, fielding: { defense: 52 }, catching: { lead: 48 },
    ...
    { id: 21, name: 'ロングリリーフ', position: 'pitcher', isStarter: false, battingOrder: 0,
      ...
      physical: { speed: 42, arm: 50, throws: 'right', bodyStamina: 64, recovery: 53 }, fielding: { defense: 54 }, catching: { lead: 50 },
    ...
    { id: 22, name: 'サイド右腕', position: 'pitcher', isStarter: false, battingOrder: 0,
      ...
      physical: { speed: 40, arm: 48, throws: 'right', bodyStamina: 70, recovery: 46 }, fielding: { defense: 50 }, catching: { lead: 44 },
    ...
    { id: 23, name: 'アンダー投手', position: 'pitcher', isStarter: false, battingOrder: 0,
      ...
      physical: { speed: 38, arm: 46, throws: 'right', bodyStamina: 68, recovery: 59 }, fielding: { defense: 48 }, catching: { lead: 42 },
    ...
    { id: 24, name: '先発候補', position: 'pitcher', isStarter: false, battingOrder: 0,
      ...
      physical: { speed: 44, arm: 52, throws: 'right', bodyStamina: 62, recovery: 48 }, fielding: { defense: 56 }, catching: { lead: 52 },
...
export const createAwayBench = () => {
  return [
    ...
    { id: 18, name: '勝利の方程式', position: 'pitcher', isStarter: false, battingOrder: 0,
      ...
      physical: { speed: 42, arm: 52, throws: 'right', bodyStamina: 66, recovery: 52 }, fielding: { defense: 52 }, catching: { lead: 48 },
    ...
    { id: 19, name: '守護神', position: 'pitcher', isStarter: false, battingOrder: 0,
      ...
      physical: { speed: 40, arm: 50, throws: 'right', bodyStamina: 69, recovery: 54 }, fielding: { defense: 50 }, catching: { lead: 44 },
    ...
    { id: 20, name: '左の中継ぎ', position: 'pitcher', isStarter: false, battingOrder: 0,
      ...
      physical: { speed: 44, arm: 54, throws: 'left', bodyStamina: 47, recovery: 72 }, fielding: { defense: 54 }, catching: { lead: 50 },
    ...
    { id: 21, name: 'イニングイーター', position: 'pitcher', isStarter: false, battingOrder: 0,
      ...
      physical: { speed: 44, arm: 52, throws: 'right', bodyStamina: 52, recovery: 72 }, fielding: { defense: 56 }, catching: { lead: 52 },
    ...
    { id: 22, name: 'サイド左腕', position: 'pitcher', isStarter: false, battingOrder: 0,
      ...
      physical: { speed: 42, arm: 50, throws: 'left', bodyStamina: 48, recovery: 57 }, fielding: { defense: 52 }, catching: { lead: 46 },
    ...
    { id: 23, name: 'サブマリン', position: 'pitcher', isStarter: false, battingOrder: 0,
      batting: { meet: 30, power: 26, eye: 40, bats: 'right', steal: 14 },
      physical: { speed: 40, arm: 48, throws: 'right', bodyStamina: 53, recovery: 59 }, fielding: { defense: 50 }, catching: { lead: 44 },
    ...
    { id: 24, name: '若手先発', position: 'pitcher', isStarter: false, battingOrder: 0,
      ...
      physical: { speed: 46, arm: 54, throws: 'right', bodyStamina: 65, recovery: 71 }, fielding: { defense: 58 }, catching: { lead: 54 },
