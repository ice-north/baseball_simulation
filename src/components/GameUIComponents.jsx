...
export const Sidebar = ({
  ...
  <div className="w-56 bg-gray-900/95 backdrop-blur text-white h-screen fixed left-0 top-0 flex flex-col border-r border-gray-700/50">
    ...
    <nav className="flex-1 overflow-y-auto px-2 py-3 space-y-0.5">
      ...
      <SidebarButton view="prospects" icon="🔭" label="注目選手" screenMode={screenMode} managementView={managementView} setScreenMode={setScreenMode} setManagementView={setManagementView} />
