      ...
      {bracket.rounds.map((round, ri) => {
        ...
        return (
          <div key={ri} className="mb-2">
            <div className="text-gray-400 text-xs mb-1">{getRoundName(bracket, ri)}</div>
            <div className="space-y-1">
              {realMatches.map((m, mi) => (
                <div key={mi} className="flex items-center gap-2 text-sm">
                  ...
                  <span className="text-gray-600 text-xs">{m.score?.[0]}-{m.score?.[1]}</span>
    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 p-6">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-gray-400 text-sm mb-4">{q.teamDefs.length}チーム → {q.slots}枠</p>
          ...
          <button onClick={() => setSelectedRegion(null)} className="mt-4 text-gray-400 hover:text-white text-sm">
            ← 全地区一覧に戻る
          </button>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-gray-400 mb-6 text-center">6月 ― 各地区の代表が決定しました</p>
            ...
            return (
              ...
              >
                <div className="flex justify-between items-center mb-1">
                  ...
                  <span className="text-gray-500 text-xs">{q.teamDefs.length}チーム → {q.slots}枠</span>
                </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-gray-400 mb-6 text-center">8月 ― {mt.teams.length}チームによるトーナメント</p>
        ...
        <div className="bg-yellow-900/30 border border-yellow-700 rounded-lg p-4 mt-4 text-center">
          ...
          <div className="text-gray-400 text-sm">準優勝: {toshitaikou.runnerUp}</div>
        </div>
        ...
        {userTeamName && mt.teams.some(t => t.name === userTeamName) && (
          <div className="text-center mt-2">
            {toshitaikou.champion === userTeamName
              ...
              : <p className="text-gray-400 text-sm">あなたのチーム: {userTeamName}</p>
            }
          </div>
        )}
