      ...
      return (
        <div className="space-y-4">
          <Entry title="ミート（meet）" range="1〜99">
            ...
            <b className="text-yellow-300">コンディションにより±10</b>の補正あり（好不調の影響が最も大きい能力）。
          </Entry>
          <Entry title="パワー（power）" range="1〜99">
            打球の飛距離を決める能力。値が高いほど長打・ホームランの確率が上がる。
            コンディションにより<b>±5</b>の補正あり。
            <span className="text-gray-400">
              ——ミートの半分に抑えてある。本塁打はパワーに対して急に増えるので、
              ミートと同じ幅にすると絶好調の日に本塁打が6倍出てしまう。
            </span>
          </Entry>
          <Entry title="選球眼（eye）" range="1〜99">
            ストライクとボールを見極める能力。値が高いほど四球を選びやすく、ボール球を振りにくい。
            <b>コンディションの影響は受けない</b>（見極めは調子で変わらない）。
          </Entry>
    ...
    case 'pitching':
      return (
        <div className="space-y-4">
          ...
          <Entry title="回転（spinRate）" range="1〜99">
            球の回転量。<b className="text-yellow-300">主戦場はストレート</b>で、
            高回転ならホップ成分で打者の予測軌道とズレて空振りが増え、打たれてもフライになりやすい
            （低回転はゴロが増える）。
            <ul className="list-disc list-inside text-sm space-y-1 mt-2">
              <li>回転0→100でストレートの空振りが<b>+30.8pt</b>、変化球は<b>+9.6〜11.9pt</b>と控えめ</li>
              <li>変化球には「実質の変化量が最大±8される」形で効く。空振りだけでなく<b>制球・球速差・釣り球の効き</b>も少し動く</li>
              <li><b>遅い球ほど増幅される</b>（滞空時間が長く、回転が変化量に変わる時間がある）</li>
              <li>平均は38前後。60を超えると明確な武器になる</li>
            </ul>
          </Entry>
