...
export const UNIVERSITY_TEAMS = [
  ...
  { id: 204, name: '三重中京大学', region: 'tokai', rank: 'C', budget: 45, specialties: ['athletic', 'technique'] },
  ...
  { id: 209, name: '岡山理科大学', region: 'chugoku', rank: 'B', budget: 55, specialties: ['technique', 'athletic', 'stamina'] },
