...
import { Sidebar, RenderBases, AccordionSection, TeamPitcherPanel } from './components/GameUIComponents.jsx';
...
<span className="text-sm text-gray-300 font-semibold">{throwHand}{batHand}</span>
              ...
              {/* アウェイチーム 試合スタッツ/投手詳細 */}
              <TeamPitcherPanel team={awayTeam} gameStarted={gameStarted} />
            </div>
...
<span className="text-sm text-gray-300 font-semibold">{throwHand}{batHand}</span>
              ...
              {/* ホームチーム試合スタッツ/投手詳細 */}
              <TeamPitcherPanel team={homeTeam} gameStarted={gameStarted} />
            </div>
          </div>
