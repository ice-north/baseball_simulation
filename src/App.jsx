...
// Data imports
import './players.js';
import './teams-data.js';
import './data/playerNames.js';

// Game logic imports
import './simulation-logic.js';
import './game/gameState.js';
import './game/autoSimulation.js';

// Season management imports
import './season/seasonManager.js';
import './season/scheduleGenerator.js';
import './season/calendarUI.js';
import './season/regulationSettings.js';
import './season/dateProgression.js';
import './season/tryoutSystem.js';
import './season/yearProgressionSystem.js';

// Note: Since the original files use global window objects and don't export all functions,
// we'll need to access them through window object until they're properly modularized
const {
  createSeasonData,
...
const RosterScreen = () => {
  ...
  return (
    <div className="p-8">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-3xl font-bold text-white mb-6">👥 ロスター管理</h1>
