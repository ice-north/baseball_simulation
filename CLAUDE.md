...
- **制球の効きは非線形**（`cc()`。リーグ平均の制球57を支点に、離れるほど効きを強める）
  ...
  - 効き: 制球20→×1.34 / 40→×1.04 / 57→0 / 80→×2.82 / 100→×4.40
- **制球別の9イニングあたり四球（打者ミート55/選球眼50で実測）**
  | 制球 | 20 | 40 | 60 | 80 | 100 |
  |---|---|---|---|---|---|
  | BB/9 | 7.4 | 5.3 | 3.5 | 1.8 | 0.2 |
  | ストライク率 | 55.8% | 59.5% | 63.3% | 69.6% | 83.9% |
  | ゾーン率 | 41.9% | 44.5% | 47.2% | 51.6% | 64.9% |
  - 制球20〜80は実データのゾーン率44-55%・chase 28-31%の範囲に収まる
  - **制球90-100は意図的に実データの外**。BB/9 0.2は実在しない水準（MLB記録0.43）なので、
    能力上限＝現実を超えた投手として扱っている。ゾーン率57-65%はここでのみ発生する
