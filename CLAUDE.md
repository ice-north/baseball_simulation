...
- `src/university/universityTeamsData.js` - 大学チームデータ（将来の大学モード用。14リーグ90校（東都2部制12校＋13リーグ×6校）、ランク別成長倍率定義）
