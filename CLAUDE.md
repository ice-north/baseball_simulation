...
- `src/university/universityTeamsData.js` - 大学チームデータ（21リーグ168校（2部制7リーグ×12校＋1部制14リーグ×6校）、ランク別成長倍率定義）
- `src/university/universityLeagueManager.js` (~280行) - 大学リーグ戦シミュレーション（21リーグ春季・秋季、スケジュール生成・試合シミュレーション・順位表管理）
...
- **ランク別進路振り分け（オフシーズン）**: `distributeHighSchoolGraduates(enrollYear)` でドラフト漏れをS→A→B→C→Dの順に配分
  ...
  - 大学チーム数×受け入れ数で各ランクの大学スロットを決定（S:120, A:273, B:429, C:549, D:273）
...
- **対象**: 社会人(300チーム)・独立リーグ(26チーム)・大学(168校) すべてのチーム
...
- **チームデータ** (`universityTeamsData.js`): `UNIVERSITY_TEAMS` に168校定義（21リーグ、2部制7リーグ）
  - 首都圏7リーグ(78校): 東京六大学, 東都1部+2部, 首都1部+2部, 東京新1部+2部, 千葉県1部+2部, 神奈川1部+2部, 関甲新1部+2部
  - 地方14リーグ(90校): 北海道学生, 北東北大学, 仙台六大学, 愛知1部+2部, 関西学生, 関西六大学, 京滋大学, 阪神大学, 近畿学生, 広島六大学, 四国地区, 福岡六大学, 九州六大学, 九州地区
- **リーグ戦** (`universityLeagueManager.js`): 21リーグの春季(4/5〜6/10)・秋季(9/6〜11/5)リーグ戦
  ...
  - DateProgressScreenで折りたたみ表示（全21リーグ個別展開可）
