...
- 内野の方向帯: 三塁 `< -24` / 遊撃 `< 3` / 二塁 `< 28` / 一塁 `>= 28`（+野手の足で境界が拡張）
- 実測分布: 中堅17.1% / 右翼17.2% / 左翼15.5% / 遊撃12.4% / 二塁11.9% / 一塁10.5% /
  三塁10.4% / 投手3.2% / 捕手1.7%（内野50.2% / 外野49.8%）
  - 右翼>左翼になるのは左打者が55%と多いため（実データは左翼がやや多い）
