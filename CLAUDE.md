...
## コミット履歴（最近5件）
1. `962b4c8` - 選手名データベースの重み付けを修正(パーセンテージをそのまま使用)
2. `9270062` - 引継ぎファイル作成: 選手名データベースの重み付け修正タスク
3. `11066a9` - 選手名データベースを3000×3000に拡張
4. `80bec57` - 名前データベースエディターツールを追加
5. `a89a257` - 選手名データベースを追加
