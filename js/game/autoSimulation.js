window.autoSimulateGame = (homeTeamName, awayTeamName) => {
...
// その日の全試合を自動実行
window.autoSimulateDailyGames = (currentDate, allGames, setAllGames, setCalendar, setLeagueStandings) => {
...
// 日程進行処理
window.advanceDate = (currentDate, calendar, setCurrentDate, setCalendar, allGames, setAllGames, setLeagueStandings) => {
  const currentDateStr = `${currentDate.month}/${currentDate.day}`;
